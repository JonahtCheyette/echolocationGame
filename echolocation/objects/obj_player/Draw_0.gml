...
if(surface_exists(obj_bubbleSurface.surface)){
	...
	if(invincibilityFrames > 0){
		draw_sprite_ext(outlineSprite, image_index, x - camera_get_view_x(view_camera[0]), y - camera_get_view_y(view_camera[0]), image_xscale, image_yscale, pointerRotation - 90, c_black, (invincibilityFrames%20)/20);
	}
